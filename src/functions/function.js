...
const gettrack_value = function (obj, { track, value }) {
  ...
  let trackIsset = ifTrack(obj, parts, 0);
  ...
  return newVal(obj, parts, value, 0);
  ...
  // if (copy.type === "label") {
  //   console.log(
  //     "Путь не корректен, Укажите свойство для элемента",
  //     copy.type
  //   );
  //   return undefined;
  // }
  ...
  // if (
  //   (parts[parts.length - 1] === "content" && value) ||
  //   (copy.type === "panel" && value)
  // ) {
  ...
  //       let addNewObj = {
  //         ...obj,
  //         content: [...obj.content, strtoJSONforcontent],
  //       };
  //       return addNewObj;
  //     } catch (err) {
  //       console.log("Ошибка в свойствах объекта");
